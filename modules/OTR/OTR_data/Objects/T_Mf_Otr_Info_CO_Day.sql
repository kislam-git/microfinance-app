CREATE TABLE MF_OTR_INFO_CO_DAY
    (
    ...
    CONSTRAINT MF_OTR_INFO_CO_DAY_PK PRIMARY KEY (COMPANY_CODE, COMPANY_BRANCH_CODE, FINANCE_CODE, PROJECT_CODE, COMPONENT_CODE,FY_YEAR, MNYR, TRANSACTION_DAY, CO_ID)
