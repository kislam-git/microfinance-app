  CREATE TABLE MF_OTR_INFO_COMP_DAY
    ...
    CONSTRAINT MF_OTR_INFO_COMP_DAY_PK PRIMARY KEY (COMPANY_CODE, COMPANY_BRANCH_CODE, FINANCE_CODE, PROJECT_CODE, COMPONENT_CODE,FY_YEAR, MNYR, TRANSACTION_DAY, LOAN_CODE)
